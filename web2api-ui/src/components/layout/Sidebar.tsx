...
// ── Collapsed icon sidebar content ──────────────────────────────────────────
...
// Always visible below md (never hidden the way the old hamburger-only pattern
// was) so the sidebar's core actions stay reachable without opening the full
// drawer. Tapping "expand"/"search" opens the MobileSidebar drawer instead of
// toggling an in-flow w-64 layout, which wouldn't fit a phone-width viewport.
